...
alias qkd="export https_proxy=http://127.0.0.1:7890 http_proxy=http://127.0.0.1:7890 all_proxy=socks5://127.0.0.1:7890; python /Users/aromia/Creation/Programming/Python/pic_downloader/fast_download.py; export https_proxy='' http_proxy='' all_proxy=''"
